System.registerDynamic("moment", [], false, function(__require, __exports, __module) {
...
System.register("src/components/ng2-datepicker", ["angular2/core", "angular2/common", "moment"], function(exports_1) {
  ...
  return {
    ...
    execute: function() {
      ...
      DatePicker = (function() {
        ...
        __decorate([core_1.Input('model-format'), __metadata('design:type', String)], DatePicker.prototype, "modelFormat", void 0);
        __decorate([core_1.Input('view-format'), __metadata('design:type', String)], DatePicker.prototype, "viewFormat", void 0);
        __decorate([core_1.Input('init-date'), __metadata('design:type', String)], DatePicker.prototype, "initDate", void 0);
        __decorate([core_1.Input('first-week-day-sunday'), __metadata('design:type', Boolean)], DatePicker.prototype, "firstWeekDaySunday", void 0);
        __decorate([core_1.Input('static'), __metadata('design:type', Boolean)], DatePicker.prototype, "isStatic", void 0);
        __decorate([core_1.Output(), __metadata('design:type', core_1.EventEmitter)], DatePicker.prototype, "changed", void 0);
        DatePicker = __decorate([core_1.Component({
          ...
          pipes: []
        }), __metadata('design:paramtypes', [common_1.NgModel, core_1.ViewContainerRef])], DatePicker);
        return DatePicker;
      })();
...
System.register("ng2-datepicker", ["./src/components/ng2-datepicker"], function(exports_1) {
  ...
  return {
    setters: [function(ng2_datepicker_1_1) {
      ng2_datepicker_1 = ng2_datepicker_1_1;
      exportStar_1(ng2_datepicker_1_1);
    }],
    execute: function() {
      exports_1("default", {directives: [ng2_datepicker_1.DatePicker]});
    }
  };
});
